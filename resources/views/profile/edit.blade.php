  ...
  <div class="content">
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-md-6">
          <form method="post" action="/update_data/{{ $User->id }}/updateData" class="form-horizontal">
            @csrf
            <div class="card ">
              <div class="card-header card-header-warning">
              ...
              <div class="card-body ">
                <div class="row">
                  ...
                  <div class="col-sm-7">
                    <div class="form-group">
                      <input class="form-control" name="altura" id="input-password" type="text" placeholder="{{ __('Altura') }}" value="{{ $User_alt / 100 }}" required />
                    </div>
                  </div>
                </div>
                <div class="row">
                ...
                <div class="row">
                  ...
                  <div class="col-sm-7">
                    <div class="form-group">
                      <input class="form-control" input type="text" name="peso" id="input-current-password" value="{{ $User_imc }}" required />
                    </div>
                  </div>
                </div>
              </div>
              <div class="card-footer ml-auto mr-auto">
                <button type="submit" class="btn btn-success">{{ __('Atualizar Informações') }}</button>
              </div>
            </div>
          </form>
        </div>
